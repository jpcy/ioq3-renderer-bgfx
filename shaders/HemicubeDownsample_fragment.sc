...
void main()
{
	...
	vec4 lb = texelFetch(u_HemicubeBatch, h_uv + ivec2(0, 0), 0);
	vec4 rb = texelFetch(u_HemicubeBatch, h_uv + ivec2(1, 0), 0);
	vec4 lt = texelFetch(u_HemicubeBatch, h_uv + ivec2(0, 1), 0);
	vec4 rt = texelFetch(u_HemicubeBatch, h_uv + ivec2(1, 1), 0);
